...
struct CanvasScrollBridge: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WheelRegion { let view = WheelRegion(); view.pan = pan; view.zoom = zoom; return view }
    func updateNSView(_ view: WheelRegion, context: Context) { view.pan = pan; view.zoom = zoom }
